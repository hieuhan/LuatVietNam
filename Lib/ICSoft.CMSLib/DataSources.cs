...
namespace ICSoft.CMSLib
{
    ...
    {   
        ...
        public List<DataSources> GetList()
        {
            ...
            try
            {
                string sql = "SELECT * FROM V$DataSources";
        ...
        public List<DataSources> GetListByDisplayTypeId(short DisplayTypeId)
        {
            ...
            try
            {
                if (DisplayTypeId > 0)
                {
                    string sql = "SELECT * FROM V$DataSources WHERE (DisplayTypeId=" + DisplayTypeId.ToString() + ")";
                    SqlCommand cmd = new SqlCommand(sql);
                    RetVal = Init(cmd);
                }
            }
        ...
        public List<DataSources> GetListByDataTypeId(byte DataTypeId)
        {
            ...
            try
            {
                if (DataTypeId > 0)
                {
                    string sql = "SELECT * FROM V$DataSources WHERE (DataTypeId=" + DataTypeId.ToString() + ") ORDER BY DataSourceName";
                    SqlCommand cmd = new SqlCommand(sql);
                    RetVal = Init(cmd);
                }
            }
        ...
        public List<DataSources> GetListByDataSourceId(short DataSourceId)
        {
            ...
            try
            {
                if (DataSourceId > 0)
                {
                    string sql = "SELECT * FROM V$DataSources WHERE (DataSourceId=" + DataSourceId.ToString() + ")";
                    SqlCommand cmd = new SqlCommand(sql);
                    RetVal = Init(cmd);
                }
            }
