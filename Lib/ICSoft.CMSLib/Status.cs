...
namespace ICSoft.CMSLib
{
    public class Status
    {
        ...
        public List<Status> GetList()
        {
            ...
            try
            {
                string sql = "SELECT * FROM V$Status";
        ...
        public List<Status> GetListByStatusID(byte StatusID)
        {
            ...
            try
            {
                if (StatusID > 0)
                {
                    string sql = "SELECT * FROM V$Status WHERE (StatusID=" + StatusID.ToString() + ")";
                    SqlCommand cmd = new SqlCommand(sql);
                    RetVal = Init(cmd);
                }
            }
        ...
        public static Status Static_Get(byte StatusID, List<Status> lList)
        {
            ...
            {
                RetVal = lList.Find(i => i.StatusID == StatusID);
                if (RetVal == null) RetVal = new Status();
            }
            return RetVal;
        }
        //--------------------------------------------------------------
