...
namespace ICSoft.LawDocsLib
{
    public class CustomersView
    {
        ...
        //-----------------------------------------------------------------
        public static CustomersView Static_Get(int CustomerId, List<CustomersView> list)
        {
            CustomersView RetVal = list.Find(i => i.CustomerId == CustomerId);
            return RetVal == null ? new CustomersView() : RetVal;
        }
    }
}