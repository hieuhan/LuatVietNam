    ...
    public class CustomerFields
    {
        ...
        public List<CustomerFields> GetListFieldsByCustomerId(int customerId)
        {
            ...
            try
            {
                if (customerId > 0)
                {
                    string sql = "SELECT * FROM CustomerFields WHERE (CustomerId=" + customerId + ")";
        ...
        //--------------------------------------------------------------  
        public List<CustomerFields> GetListFieldsByCustomerId2(int customerId, byte reviewStatusId = 2)
        {
            List<CustomerFields> RetVal = new List<CustomerFields>();
            try
            {
        ...
        //--------------------------------------------------------------  
        public List<CustomerFields> GetListFieldsById(int customerId, byte docGroupId, byte reviewStatusId = 2)
        {
            List<CustomerFields> RetVal = new List<CustomerFields>();
            try
            {
                ...
                {
                    string sql = "SELECT * FROM CustomerFields WHERE (CustomerId=" + customerId +
                                    ") AND FieldId IN (SELECT FieldId FROM Fields WHERE ReviewStatusId = " + reviewStatusId + ") AND DocGroupId = " + docGroupId;
                    SqlCommand cmd = new SqlCommand(sql);
                    RetVal = Init(cmd);
                }
            }
        ...
        //-------------------------------------------------------------- 
        public DataSet CustomerFields_GetCount2(int CustomerId, byte LanguageId, int DocGroupId, byte GetCountByField, byte GetCountByProvince)
        {
            DataSet RetVal = new DataSet();
            try
            {
                SqlCommand cmd = new SqlCommand("CustomerFields_GetCount2");
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@LanguageId", LanguageId));
                cmd.Parameters.Add(new SqlParameter("@CustomerId", CustomerId));
                cmd.Parameters.Add(new SqlParameter("@DocGroupId", DocGroupId));
        ...
        //-------------------------------------------------------------- 
        public void CustomerFields_GenMessageByRequestId(int messageSendRequestId = 0)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("CustomerFields_GenMessageByRequestId");
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@MessageSendRequestId", messageSendRequestId));
                db.ExecuteSQL(cmd);
            }
            catch (Exception ex)
            {
        ...
        //--------------------------------------------------------------  
        public List<CustomerFields> CustomerFields_GetReportByRequestId(int messageSendRequestId , string keyword , int pageSize, int pageNumber, ref int rowCount)
        {
            List<CustomerFields> list = new List<CustomerFields>();
            try
            {
                SqlCommand cmd = new SqlCommand("CustomerFields_GetReportByRequestId");
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@MessageSendRequestId", messageSendRequestId));
        ...
        //--------------------------------------------------------------  
        public string CustomerFields_GetContentMessageByCustomerIdAndRequestId(int customerId, int messageSendRequestId)
        {
            string retVal = "";
            ...
            {
                sqlConnection.Open();
                SqlCommand cmd = new SqlCommand("CustomerFields_GetContentMessageByCustomerIdAndRequestId",sqlConnection);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@CustomerId", customerId));
                cmd.Parameters.Add(new SqlParameter("@MessageSendRequestId", messageSendRequestId));
