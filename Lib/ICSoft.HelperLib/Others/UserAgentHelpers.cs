...
namespace ICSoft.HelperLib
{
    ...
    public static class UserAgentHelper
    {
        ...
        {
            var mobileContains = ConstantHelpers.MobileUserAgents.Split(',').Where(m => !string.IsNullOrEmpty(m)).Select(m => m.Trim().ToLowerInvariant());
        ...
        /// </returns>
        public static bool IsNotCheckedForCookiesAndJs(string userAgent)
        {
            if (!string.IsNullOrEmpty(userAgent))
            {
        ...
        {
            ValidationHelper.VerifyNotNull(platform, "platform");
            ...
            else
            {
                ...
                isSearchEngine = isCrawler || !string.IsNullOrEmpty(san);
