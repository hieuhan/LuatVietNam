...
function showNotification(params){
	...
	var container = '<div id="info_message" class="notification_background ' + msgclass + '" onclick="return closeNotification();" title="Click to Hide Notification"><span style="color:Gray; position:absolute; left:5px; top:2px">Click vào thông báo để đóng</span><div class="center_auto"><div class="info_message_text message_area">';
