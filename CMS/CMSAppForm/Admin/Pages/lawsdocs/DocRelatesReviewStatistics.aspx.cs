...
public partial class Admin_DocRelatesReviewStatistics : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            m_grid.DataSource = m_DocRelates.GetPage(ActUserId, m_grid.PageSize, CustomPaging.PageIndex - 1, m_OrderBy, m_LanguageId, m_Field, m_DocId, m_DocReferenceId, m_RelateTypeId, m_ReviewStatusId, m_CrUserId, m_SearchByDate, m_DateFrom, m_DateTo, ref RowCount);
            m_grid.DataBind();
