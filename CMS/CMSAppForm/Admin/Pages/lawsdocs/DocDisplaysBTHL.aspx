<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocDisplaysBTHL.aspx.cs" Inherits="Admin_DocDisplaysBTHL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
	...
	<div class="chucnangright">
		<a id="popup" href="DocsSelected.aspx?DisplayTypeId=<%= ddlDisplayTypes.SelectedValue %>&LanguageId=<%=ddlLanguage.SelectedValue %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
