<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdminEdit.master" AutoEventWireup="true" CodeFile="DocRelatesVietNamStandard.aspx.cs" Inherits="Admin_DocRelatesVietNamStandard" %>
...
<script type="text/javascript">
    ...
    <table cellpadding="3" cellspacing="0" style="width:100%">
        ...
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Font-Bold="false" Text="» VB Công bố, ban hành:"></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td>
                <asp:Panel runat="server" DefaultButton="lbtCongBo">
                <asp:TextBox ID="txtVBCongBo" runat="server" CssClass="tukhoatimekiem" 
                    Width="210px"></asp:TextBox>
                &nbsp;<asp:Button ID="lbtCongBo" runat="server" CssClass="themmoi"  Text="Thêm" ValidationGroup="G10" OnClick="lbtCongBo_Click" > </asp:Button><br/>
                <asp:RequiredFieldValidator ID="rfvtxtVBCongBo" Text="Bạn cần nhập VB Công bố, ban hành" runat="server" Display="Dynamic"
                    ValidationGroup="G10"
                    ControlToValidate="txtVBCongBo" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
            <td>
                <asp:Label ID="Label2" runat="server" Font-Bold="false" 
                    meta:resourcekey="lblVBHethieuluc" Text="» VB Hủy bỏ tiêu chuẩn:"></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td>
                <asp:Panel runat="server" DefaultButton="lbtHuyBo">
                <asp:TextBox ID="txtVBHuyBo" runat="server" CssClass="tukhoatimekiem" 
                    Width="210px"></asp:TextBox>
                &nbsp;<asp:Button ID="lbtHuyBo" runat="server" CssClass="themmoi"  ValidationGroup="G12" Text="Thêm" OnClick="lbtHuyBo_Click"> </asp:Button><br/>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" 
                ErrorMessage="Bạn cần nhập VB Hủy bỏ tiêu chuẩn" ValidationGroup="G12" 
                ControlToValidate="txtVBHuyBo" ForeColor="Red"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label3" runat="server" Font-Bold="false" Text="» VB Được dẫn chiếu:"></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td>
                <asp:Panel runat="server" DefaultButton="lbtVBDuocDanChieu">
                <asp:TextBox ID="txtVBDuocDanChieu" runat="server" CssClass="tukhoatimekiem" 
                    Width="210px"></asp:TextBox>
                &nbsp;<asp:Button ID="lbtVBDuocDanChieu" runat="server" CssClass="themmoi"  Text="Thêm" ValidationGroup="G11" OnClick="lbtVBDuocDanChieu_Click" > </asp:Button><br/>
                <asp:RequiredFieldValidator ID="rfvtxtVBDuocDanChieu" Text="Bạn cần nhập VB Được dẫn chiếu" runat="server" Display="Dynamic"
                    ValidationGroup="G11"
                    ControlToValidate="txtVBDuocDanChieu" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
            <td>
                <asp:Label ID="Label4" runat="server" Font-Bold="false" Text="» VB Được căn cứ:"></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td>
                <asp:Panel runat="server" DefaultButton="lbtVBDuocCanCu">
                <asp:TextBox ID="txtVBDuocCanCu" runat="server" CssClass="tukhoatimekiem" 
                    Width="210px"></asp:TextBox>
                &nbsp;<asp:Button ID="lbtVBDuocCanCu" runat="server" CssClass="themmoi"  ValidationGroup="G2" Text="Thêm" OnClick="lbtVBDuocCanCu_Click"> </asp:Button><br/>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" 
                ErrorMessage="Bạn cần nhập VB Được căn cứ" ValidationGroup="G2" 
                ControlToValidate="txtVBDuocCanCu" ForeColor="Red"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="lblVBCancu" runat="server" Font-Bold="false" Text="» TC bị sửa đổi bổ sung :"></asp:Label>
                    <span class="icon-required"></span>
            </td>
            <td>
                ...
                ErrorMessage="Bạn cần nhập TC bị sửa đổi bổ sung" ValidationGroup="G1" 
                ControlToValidate="txtVBCancu" ForeColor="Red"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
            <td>
                <asp:Label ID="lblVBHethieuluc" runat="server" Font-Bold="false"  Text="» TC bị đính chính :"></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td>
                ...
                &nbsp;<asp:Button ID="lbAddVBHethieuluc" runat="server" CssClass="themmoi" 
                    meta:resourcekey="lbAddVBHethieuluc" onclick="lbAddVBHethieuluc_Click" ValidationGroup="G16" Text="Thêm"> </asp:Button><br/>
                <asp:RequiredFieldValidator ID="rfvVBHethieuluc" runat="server" Display="Dynamic" 
                ErrorMessage="Bạn cần nhập TC bị đính chính" ValidationGroup="G16" 
        ...
        <tr>
            <td>
                <asp:Label ID="lblVBBisuadoi" runat="server" Font-Bold="false" 
                    meta:resourcekey="lblVBBisuadoi" Text="» TC bị thay thế:"></asp:Label>
                     <span class="icon-required"></span>
            </td>
            <td>
                ...
                &nbsp;<asp:Button ID="lbAddVBBisuadoi" runat="server" CssClass="themmoi" 
                    meta:resourcekey="lbAddVBBisuadoi" onclick="lbAddVBBisuadoi_Click" ValidationGroup="G4" Text="Thêm"> </asp:Button>
                <br/>
                <asp:RequiredFieldValidator ID="rfvVBBisuadoi" runat="server" Display="Dynamic" 
                ErrorMessage="Bạn cần nhập TC bị thay thế" ValidationGroup="G4" 
              ...
              <td>
                <asp:Label ID="lblVBDuocdinhchinh" runat="server" Font-Bold="false" 
                    ...
                    Text="» TC được dẫn chiếu:"></asp:Label>
                  <span class="icon-required"></span>
            </td>
            <td>
                ...
                &nbsp;<asp:Button ID="lbAddVBDuocdinhchinh" runat="server" 
                    ...
                    onclick="lbAddVBDuocdinhchinh_Click" Text="Thêm" ValidationGroup="G15"> </asp:Button><br/>
                <asp:RequiredFieldValidator ID="rfvVBDuocdinhchinh" runat="server" 
                    ControlToValidate="txtVBDuocdinhchinh" Display="Dynamic" 
                    ErrorMessage="Bạn cần nhập TC được dẫn chiếu" ForeColor="Red" ValidationGroup="G15"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label5" runat="server" Font-Bold="false" 
                    meta:resourcekey="lblVBBisuadoi" Text="» TC được căn cứ :"></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td>
                <asp:Panel runat="server" DefaultButton="lbtTCDuocCanCu">
                <asp:TextBox ID="txtTCDuocCanCu" runat="server" CssClass="tukhoatimekiem" 
                    Width="210px"></asp:TextBox>
                &nbsp;<asp:Button ID="lbtTCDuocCanCu" runat="server" CssClass="themmoi" ValidationGroup="G18" Text="Thêm" OnClick="lbtTCDuocCanCu_Click"> </asp:Button><br/>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic" 
                ErrorMessage="Bạn cần nhập TC được căn cứ" ValidationGroup="G18" 
                ControlToValidate="txtTCDuocCanCu" ForeColor="Red"></asp:RequiredFieldValidator>
                    </asp:Panel>
            </td>
              <td>
