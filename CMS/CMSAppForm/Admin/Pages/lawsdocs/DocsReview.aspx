<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocsReview.aspx.cs" Inherits="Admin_DocsReview" %>
...
<script type="text/javascript">
    ...
    <table cellpadding="3" cellspacing="0" style="width:100%">  
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlReviewStatus" runat="server" AutoPostBack="False" Enabled="false"
        ...
        <asp:GridView ID="m_grid" DataKeyNames="DocId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        <a href='<%# "DocsEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId").ToString() + "&backUrl=DocsReview.aspx"  %>' title="Sửa văn bản" style="color:black;" > 
                            <asp:Label ID="lbDocName" runat="server" Text='<%# Eval("DocName")%>' style="font-weight:bold;"></asp:Label>                        
                        </a> 
                        <br />
                        <br />
                          <a WHeight="550" WWidth="950" href="<%# "DocsEditPropertie.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId")  %>" class="popup docsproperties" onmouseover="<%# "ShowTooltip('docstips.aspx?DocId=" + Eval( "DocId").ToString() +"&LanguageId=" + Eval( "LanguageId").ToString() + "','tt'); return false;" %>" onmouseout="HideTooltip();"  >
                          ...
                          <a WHeight="430" WWidth="580" href='<%# "DocsUpdateTDADEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties <%#HasGazette(Eval("GazetteNumber").ToString(),Eval("GazetteDate").ToString()) ? "":"active" %>" WHeight="430" WWidth="580" title="<%=GetLocalResourceObject("lblGridColumnTDAD.title").ToString() %>">
                          ...
                          <a WHeight="600" WWidth="1050" href='<%# "DocRelatesEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties <%#HasProperties(Eval("HasDocRelate").ToString())  ? "":"active" %>" title="<%=GetLocalResourceObject("lblGridColumnDocRelateEdit.title").ToString() %>">
                          ...
                          <a WHeight="400" WWidth="850" href='<%# "DocsFielsEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties <%#HasProperties(Eval("HasFile").ToString())  ? "":"active" %>" title="<%=GetLocalResourceObject("lblGridColumnFile.title").ToString() %>">
                          ...
                          <a href='<%# "DocsUpdateContentEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") + "&backUrl=DocsReview.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasContent").ToString())  ? "":"active" %>" title="<%=GetLocalResourceObject("lblGridColumnContent.title").ToString() %>">
                          ...
                          <a href='<%# "DocIndexes.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId")+ "&backUrl=DocsReview.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasDocIndex").ToString())  ? "":"active" %>" title="Mục lục văn bản">
                              <asp:Label ID="Label1" runat="server" CssClass="docsproperties" Text="Mục lục" ></asp:Label>
                          </a><span class="docsproperties"> | </span>   

                          <a WHeight="500" WWidth="800" href='<%# "DocsUpdateSummaryEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties <%#string.IsNullOrEmpty(Eval("DocSummary").ToString())?"active":"" %>"  title="<%=GetLocalResourceObject("lblGridColumnSummary.title").ToString() %>"><asp:Label ID="lblGridColumnSummary" runat="server" CssClass="docsproperties" Text="Trích dẫn" meta:resourcekey="lblGridColumnSummary"></asp:Label>
                          </a><span class="docsproperties"> | </span> 

                          <a href='<%# "DocsContentRelation.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") + "&backUrl=DocsReview.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasDocRelate").ToString())  ? "":"active" %>"  title="<%=GetLocalResourceObject("lblGridColumnContentRelation.title").ToString() %>">
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        ...
                        <a href='<%# "DocsEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId")  %>' title="Nội dung" style="color:black;" > <b><%# LanguageId==1 ? Eval("DocIdentity"):Eval("DocIdentityClear")%></b></a> <br /><br />
                ...
                <asp:TemplateField  > 
                    ...
                    <ItemTemplate> 
                       <span class="xuatban<%# Eval("ReviewStatusId") %>" > <%# LanguageHelpers.IsCultureVietnamese() ? ReviewStatus.Static_Get(byte.Parse(Eval("ReviewStatusId").ToString()), l_ReviewStatus).ReviewStatusDesc : ReviewStatus.Static_Get(byte.Parse(Eval("ReviewStatusId").ToString()), l_ReviewStatus).ReviewStatusName%></span><br />
                        <a WHeight="400" WWidth="550" href="<%=CmsConstants.ROOT_PATH %>admin/pages/WebNotify/NotifyMessagesEdit.aspx?DocId=<%# Eval("DocId") %>&LanguageId=<%# Eval("LanguageId") %>&BackUrl=Pages/lawsdocs/DocsReview.aspx" class="popup" style="color:blue;" title="Gửi Web Notify"> Gửi Notify</a>    
                    </ItemTemplate>
