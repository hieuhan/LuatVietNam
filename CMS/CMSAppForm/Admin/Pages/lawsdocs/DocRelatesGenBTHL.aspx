<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocRelatesGenBTHL.aspx.cs" Inherits="Admin_DocRelatesGenBTHL" %>
...
<script type="text/javascript">
	...
	<div class="chucnangright">
     <a id="popup" href="ShowGenBTHL.aspx?ActionType=Create&LanguageId=<%= ddlLanguage.SelectedValue %>&DateFrom=<%=txtDateFrom.Text %>&&DateTo=<%=txtDateTo.Text %>&RelateTypeId=<%=m_RelateTypeId %>" title="<%=GetLocalResourceObject("lblShowGenBTHL.title").ToString() %>" class="themmoi" > 
            <asp:Label ID="lblShowGenBTHL" runat="server" Text="Hiển thị BTHL" meta:resourcekey="lblShowGenBTHL"></asp:Label>
        </a>
	</div>
