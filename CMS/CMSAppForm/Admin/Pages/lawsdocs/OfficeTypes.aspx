<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="OfficeTypes.aspx.cs" Inherits="Admin_OfficeTypes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    ...
    <div class="chucnangleft">
        ...
        <%=GetLocalResourceObject("OfficeTypes").ToString()%>
	</div>
	<div class="chucnangright">
		<a id="popup" href="OfficeTypesEdit.aspx" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="OfficeTypeId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("OfficeTypeId") %>')" href='OfficeTypesEdit.aspx?OfficeTypeId=<%# Eval("OfficeTypeId") %>' class="iconadmsua"
