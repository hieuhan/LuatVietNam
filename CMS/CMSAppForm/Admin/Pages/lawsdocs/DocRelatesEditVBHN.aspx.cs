...
public partial class Admin_DocRelatesEditVBHN : System.Web.UI.Page
{
    ...
    protected void lbAddVBHNGoc_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtAddVBHNGoc.Text, REVIEW_STATUS_All, LanguageId, byte.Parse(ConfigurationManager.AppSettings["DOC_MERS2"]));
            txtAddVBHNGoc.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbAddVBHNSuaDoi_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtAddVBHNSuaDoi.Text, REVIEW_STATUS_All, LanguageId, byte.Parse(ConfigurationManager.AppSettings["DOC_MER2"]));
            txtAddVBHNSuaDoi.Text = "";
        }
        catch (Exception ex)
        {
