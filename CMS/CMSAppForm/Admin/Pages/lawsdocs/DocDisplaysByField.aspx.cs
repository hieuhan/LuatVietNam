...
public partial class Admin_DocDisplays : System.Web.UI.Page
{
    ...
    private void BindData(int index)
    {
        try
        {
            ...
            short.TryParse(ddlFields.SelectedValue,out FieldId);
            DropDownListHelpers.DDLFields_BindByCulture(ddlFields, Fields.Static_GetListByLanguage(LanguageId), "", FieldId.ToString());
            m_grid.EditIndex = index;
            m_grid.DataSource = m_DocDisplays.DocDisplays_GetListByFieldId(ActUserId, m_OrderBy, m_DisplayTypeId, LanguageId,FieldId);
