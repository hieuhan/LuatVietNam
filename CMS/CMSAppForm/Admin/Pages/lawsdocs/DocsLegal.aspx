<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocsLegal.aspx.cs" Inherits="Admin_Docs" %>
...
<script type="text/javascript">
   ...
   <table cellpadding="3" cellspacing="0" style="width:100%">
        <tr>
            ...
            <td valign="middle" style="width:110px; white-space:nowrap;">              
	...
	<div class="chucnangright">
         <a href="DocsLegalEdit.aspx?LanguageId=<%=LanguageId %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
    ...
    <div style="text-align:left; width:40%; float:right"><asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="upn_Grid" runat="server">
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        ...
                        <br />
                        <br />
                          <asp:HyperLink ID="hlkproperties" runat="server"  NavigateUrl='<%# "DocsLegalEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId")  %>' class="docsproperties" onmouseover='<%# "ShowTooltip(" + chr + "docstips.aspx?DocId=" + Eval( "DocId") +"&LanguageId=" + Eval( "LanguageId") + chr +"," + chr + "tt" + chr + "); return false;" %>' onmouseout='HideTooltip();' EnableViewState="False"  ><asp:Label ID="lblGridColumnProperties" runat="server" CssClass="docsproperties" Text="Thuộc tính" meta:resourcekey="lblGridColumnProperties" ></asp:Label></asp:HyperLink></a><span class="docsproperties"> | </span>  
                          <a id="popup" WHeight="430" WWidth="580" href='<%# "DocsUpdateTDADEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="docsproperties" WHeight="430" WWidth="580" title="<%=GetLocalResourceObject("lblGridColumnTDAD.title").ToString() %>"><asp:Label ID="lblGridColumnTDAD" runat="server" CssClass="docsproperties" Text="TĐ Áp dụng" meta:resourcekey="lblGridColumnTDAD"></asp:Label></a><span class="docsproperties"> | </span> 
                          ...
                          <a id="popup" WHeight="400" WWidth="500" href='<%# "DocsFielsEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="docsproperties"  title="<%=GetLocalResourceObject("lblGridColumnFile.title").ToString() %>"><asp:Label ID="lblGridColumnFile" runat="server" CssClass="docsproperties" Text="File" meta:resourcekey="lblGridColumnFile"></asp:Label></a><span class="docsproperties"> | </span>   
                          ...
                          <a id="popup" WHeight="500" WWidth="800" href='<%# "DocsUpdateSummaryEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="docsproperties"  title="<%=GetLocalResourceObject("lblGridColumnSummary.title").ToString() %>"><asp:Label ID="lblGridColumnSummary" runat="server" CssClass="docsproperties" Text="Trích dẫn" meta:resourcekey="lblGridColumnSummary"></asp:Label></a><span class="docsproperties"> | </span> 
