<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Faqs.aspx.cs" Inherits="Admin_Faqs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    ...
    <table cellpadding="4" cellspacing="0" style="width:100%">
        <tr>
            ...
            <td style="width:90px; white-space:nowrap;">
                <asp:Label ID="lblFaqGroups" runat="server" 
                    meta:resourcekey="lblFaqGroups" Text="Nhóm FAQ:"></asp:Label>
                </td>
            <td style="width:260px">
        ...
        <tr>
            ...
            <td style="width: 90px; white-space: nowrap;">
                <asp:Label ID="lblLawers" runat="server" meta:resourcekey="lblLawers" 
                    Text="Luật sư:"></asp:Label>
            </td>
            <td style="width: 260px">
                <asp:DropDownList ID="ddlLawers" runat="server" AutoPostBack="True" 
                    CssClass="userselect" DataTextField="FullName" 
                    DataValueField="LawerId" 
        ...
        <tr>
            ...
            <td> <asp:Button ID="btnSearch" runat="server" CssClass="timkiembutom" 
                    meta:resourcekey="btnSearch" onclick="btnSearch_Click" Text="Tìm kiếm"> </asp:Button><asp:LinkButton ID="btnRefresh" runat="server" CssClass="timkiembutom hidden-btn-dqs" Text="LÃ m má»i" onclick="btnRefresh_Click"></asp:LinkButton>	</td>
            <td></td>
        </tr>
	...
	<div class="chucnangright">        
		<a id="popup" href="FaqsEdit.aspx" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="FaqId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnFaqCode" runat="server" Text="Mã câu hỏi" meta:resourcekey="lblGridColumnFaqCode"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                        <%# Eval("FaqCode")%> 
                    </ItemTemplate>
               ...
               <%--<asp:TemplateField  > 
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("FaqId") %>')" href='FaqsEdit.aspx?FaqId=<%# Eval("FaqId") %>' class="iconadmsua"
