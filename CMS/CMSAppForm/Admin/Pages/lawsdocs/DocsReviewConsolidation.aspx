<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocsReviewConsolidation.aspx.cs" Inherits="Admin_DocsReviewConsolidation" %>
...
<asp:Panel ID="panSearch" runat="server" DefaultButton="btnSearch" Width="100%" >
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlSearchByDate" runat="server" AutoPostBack="False" 
                    ...
                    <asp:ListItem Value="IssueDate" Selected="True">Ngày ký xác thực</asp:ListItem>
	...
	<div class="chucnangright">
         <a href="DocsConsolidationEdit.aspx?LanguageId=<%=LanguageId + "&backUrl=DocsReviewConsolidation.aspx" %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
        ...
        <asp:GridView ID="m_grid" DataKeyNames="DocId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        <a href='<%# "DocsConsolidationEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId").ToString() + "&backUrl=DocsReviewConsolidation.aspx"  %>' title="Sửa văn bản" style="color:black;" > 
                            <asp:Label ID="lbDocName" runat="server" Text='<%# Eval("DocName")%>' style="font-weight:bold;"></asp:Label>                        
                        </a> 
                        <br />
                        <br />
                          <a WHeight="510" WWidth="1130" href="<%# "DocsEditPropertie.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId")  %>" class="popup docsproperties" onmouseover="<%# "ShowTooltip('docstips.aspx?DocId=" + Eval( "DocId").ToString() +"&LanguageId=" + Eval( "LanguageId").ToString() + "','tt'); return false;" %>" onmouseout="HideTooltip();"  >
                        ...
                        <a WHeight="600" WWidth="1050" href="<%# "DocRelatesEditVBHN.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId")  %>" class="popup docsproperties <%#HasProperties(Eval("HasDocRelate").ToString())  ? "":"active" %>"  >
                            <asp:Label ID="Label3" runat="server" CssClass="docsproperties" Text="Liên quan" ></asp:Label>
                            </a>
                        ...
                        <span class="docsproperties"> | </span>   
                         ...
                         <a href='<%# "DocsUpdateContentEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId").ToString() + "&backUrl=DocsReviewConsolidation.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasContent").ToString())  ? "":"active" %>" title="<%=GetLocalResourceObject("lblGridColumnContent.title").ToString() %>">
                       ...
                       <a href='<%# "DocIndexes.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId").ToString() + "&backUrl=DocsReviewConsolidation.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasDocIndex").ToString())  ? "":"active" %>" title="Mục lục văn bản">
                        ...
                        <a href='<%# "DocsContentRelation.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId").ToString() + "&backUrl=DocsReviewConsolidation.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasDocRelate").ToString())  ? "":"active" %>"  title="<%=GetLocalResourceObject("lblGridColumnContentRelation.title").ToString() %>">
                        ...
                        <a WHeight="600" WWidth="800" href='<%# "DocSeoEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties <%#string.IsNullOrEmpty(Eval("MetaTitle").ToString())?"active":"" %>"  title="Seo Info"><asp:Label ID="Label4" runat="server" CssClass="docsproperties" Text="Seos"></asp:Label></a>
                ...
                <asp:TemplateField  > 
                    ...
                    <ItemTemplate> 
                        <table border="0px" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="width:60px; text-align:left;"><asp:Label ID="lblGridColumnBH" CssClass="properties" runat="server" Text="XT:" meta:resourcekey="lblGridColumnBH"></asp:Label></td>
                ...
                <asp:TemplateField  > 
                    ...
                    <ItemTemplate> 
                       <span class="xuatban<%# Eval("ReviewStatusId") %>" > <%# LanguageHelpers.IsCultureVietnamese() ? ReviewStatus.Static_Get(byte.Parse(Eval("ReviewStatusId").ToString()), l_ReviewStatus).ReviewStatusDesc : ReviewStatus.Static_Get(byte.Parse(Eval("ReviewStatusId").ToString()), l_ReviewStatus).ReviewStatusName%></span><br />
                         <a WHeight="400" WWidth="550" href="<%=CmsConstants.ROOT_PATH %>admin/pages/WebNotify/NotifyMessagesEdit.aspx?DocId=<%# Eval("DocId") %>&LanguageId=<%# Eval("LanguageId") %>&BackUrl=Pages/lawsdocs/DocsReviewConsolidation.aspx" class="popup" style="color:blue;" title="Gửi Web Notify"> Gửi Notify</a> 
                    </ItemTemplate>
