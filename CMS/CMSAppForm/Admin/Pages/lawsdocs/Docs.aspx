<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Docs.aspx.cs" Inherits="Admin_Docs" %>
...
<script src="../../Js/ajaxTooltip/ajax.js" type="text/javascript"></script>
	...
	<div class="chucnangright">
         <a href="DocsEdit.aspx?LanguageId=<%=LanguageId %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
        ...
        <asp:LinkButton ID="lbDelete" runat="server" CssClass="xoatin" Text="Xóa" OnClientClick="return confirm('Bạn có chắc chắn muốn xóa các văn bản đã chọn?')" 
            meta:resourcekey="lbDelete" ToolTip="Xóa các văn bản được tick chọn và chưa duyệt"  onclick="lbDelete_Click">
        </asp:LinkButton>
	</div>
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        ...
                        <br />
                          ...
                          <a WHeight="430" WWidth="580" href='<%# "DocsUpdateTDADEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties" WHeight="430" WWidth="580" title="<%=GetLocalResourceObject("lblGridColumnTDAD.title").ToString() %>">
                          ...
                          <a href='<%# "DocsUpdateContentEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") + "&backUrl=Docs.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasContent").ToString()) ? "":"active" %>" title="<%=GetLocalResourceObject("lblGridColumnContent.title").ToString() %>">
                          ...
                          <a WHeight="500" WWidth="800" href='<%# "DocsUpdateSummaryEdit.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") %>' class="popup docsproperties <%# getClassSeo(Eval("DocSummary"),Eval("UpdUserId"))%>"  title="<%=GetLocalResourceObject("lblGridColumnSummary.title").ToString() %>">
                          ...
                          <a href='<%# "DocsContentRelation.aspx?DocId=" + Eval("DocId").ToString() + "&LanguageId=" + Eval("LanguageId") + "&backUrl=Docs.aspx" %>' class="docsproperties <%#HasProperties(Eval("HasDocRelate").ToString()) ? "":"active" %>"  title="<%=GetLocalResourceObject("lblGridColumnContentRelation.title").ToString() %>">
