...
public partial class Admin_DocsEditInfo : System.Web.UI.Page
{
            ...
            if (DocId > 0)
            {
                ...
                if (m_Docs.DocId > 0)
                {
                    ...
                    if (m_Docs.ReviewStatusId == byte.Parse(ConfigurationManager.AppSettings["REVIEWSTATUSID"]))
                    {
                        ...
                        if (txtOrgans5 != null && txtOrgans5.Text != "")
                        {
                            txtOrgans5.Enabled = false;
                        }
                        if (txtOrgans6 != null && txtOrgans6.Text != "")
                        {
                            txtOrgans6.Enabled = false;
                        }
                        if (txResult != null && txResult.Text != "")
                        {
                            txResult.Enabled = false;
                        }
                        ...
                        if (txNumDossier != null && txNumDossier.Text != "")
                        {
                            txNumDossier.Enabled = false;
                        }
                        if (txElementDossier != null && txElementDossier.Text != "")
                        {
                            txElementDossier.Enabled = false;
                        }
                        if (txtDocIdentity != null && txtDocIdentity.Text != "")
                        {
                            txtDocIdentity.Enabled = false;
                        }
                        if (txDocObject != null && txDocObject.Text != "")
                        {
                            txDocObject.Enabled = false;
                        }
                        if (txPerformMethod != null && txPerformMethod.Text != "")
                        {
                            txPerformMethod.Enabled = false;
                        }
                        if (txSettlementTime != null && txSettlementTime.Text != "")
                        {
                            txSettlementTime.Enabled = false;
                        }
                        if (txtEffectDate != null && txtEffectDate.Text != "")
                        {
                            txtEffectDate.Enabled = false;
                        }
                        if (txFee != null && txFee.Text != "")
                        {
                            txFee.Enabled = false;
                        }
                        if (txtProvices != null && txtProvices.Text != "")
                        {
    ...
    protected void SaveData()
    {
        try
        {
            ...
            JSAlertHelpers.ShowNotify("15", "success", "Sửa thông tin thủ tục hành chính thành công.", this);
