...
public partial class Admin_Pages_lawsdocs_DocTypeReports : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            DocTypeReports m_DocTypeReports = new DocTypeReports();
            int RowCount = 0;
            byte DocGroupId = 0;
            short Week = 0;
            byte Month = 0;
            ...
            m_grid.DataSource = m_DocTypeReports.GetList(0, DocGroupId, Week, Month, Year, m_DateFrom, m_DateTo, "", CustomPaging.PageIndex - 1, m_grid.PageSize, ref RowCount);
            m_grid.DataBind();
