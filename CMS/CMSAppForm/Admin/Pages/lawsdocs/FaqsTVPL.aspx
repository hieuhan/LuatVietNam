<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="FaqsTVPL.aspx.cs" Inherits="Admin_FaqsTVPL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
        ...
        <tr>
            ...
            <td>
                &nbsp;<asp:DropDownList ID="ddlFaqGroups" runat="server" AutoPostBack="True" 
                    ...
                    Enabled="false" onselectedindexchanged="ddlFaqGroups_SelectedIndexChanged"  Visible="false"
                    Width="20px">
                </asp:DropDownList>
                <asp:Label ID="lblFaqGroups" runat="server" meta:resourcekey="lblFaqGroups" Visible="false" 
                    Text="Nhóm TVPL:"></asp:Label>
            </td>
        </tr>
	...
	<div class="chucnangright">        
		<a id="popup" href="FaqsTVPLEdit.aspx" WHeight="600" WWidth="800" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
            ...
            <Columns>                        
                <asp:TemplateField >
                 ...
                 <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        <%# Eval("Question")%> <br />
                         <a id="popup"  href='<%# "FaqDocsSelected.aspx?FaqId=" + Eval("FaqId").ToString() %>' WHeight="600" WWidth="900" title="<%=GetLocalResourceObject("lblGridColumnFaqDocsSelected.title").ToString() %>" >[<asp:Label ID="lblGridColumnVBthamchieu" runat="server" Text="VB tham chiếu" meta:resourcekey="lblGridColumnVBthamchieu"></asp:Label>]</a>
                    </ItemTemplate>
               ...
               <%--<asp:TemplateField  > 
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("FaqId") %>')" WHeight="600" WWidth="900" href='FaqsTVPLEdit.aspx?FaqId=<%# Eval("FaqId") %>' class="iconadmsua"
