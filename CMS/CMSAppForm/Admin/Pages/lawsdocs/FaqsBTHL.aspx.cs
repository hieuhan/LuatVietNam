...
public partial class Admin_FaqsBTHL : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DropDownListHelpers.DDLFaqGroups_BindByCulture(ddlFaqGroups, FaqGroups.Static_GetList(), "", ConfigurationManager.AppSettings["LAWS_BTHL"]);
