<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdminEdit.master" AutoEventWireup="true" CodeFile="FaqsEdit.aspx.cs" Inherits="Admin_FaqsEdit" %>
    ...
    <table cellpadding="3" cellspacing="0" style="width:100%; font-weight:lighter">
        ...
        <tr>
            ...
            <asp:RequiredFieldValidator ID="rfvMsgContent" runat="server" 
                    ControlToValidate="txtMsgContent" Display="Dynamic" ErrorMessage="(*)" 
                    Font-Bold="true" ForeColor="Red" ValidationGroup="G1"></asp:RequiredFieldValidator>
             </td>
            <td colspan="3">
                <CKEditor:CKEditorControl ID="txtMsgContent" runat="server" 
                                BasePath="~/Integrated/ckeditor/" Height="200px" Toolbar="Basic" Width="98%"></CKEditor:CKEditorControl>
                </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="lblFaqCode" runat="server" 
                    ...
                    <asp:RequiredFieldValidator ID="rfvFaqCode" 
                    runat="server" ControlToValidate="txtFaqCode" Display="Dynamic" 
                    ErrorMessage="(*)" ForeColor="Red" Font-Bold="true" ValidationGroup="G1"></asp:RequiredFieldValidator>
                </td>
            <td width="250px">
            ...
            <td width="90px">
                <asp:Label ID="lblFaqGroups" runat="server" meta:resourcekey="lblFaqGroups" 
                    Text="Nhóm:"></asp:Label>
            </td>
            <td>
                 <asp:DropDownList ID="ddlFaqGroups" runat="server" 
                    CssClass="userselect" DataTextField="FaqGroupDesc" 
                    DataValueField="FaqGroupId" Width="250px">
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td><asp:Label ID="lblLawers" runat="server" meta:resourcekey="lblLawers" 
                    Text="Luật sư:"></asp:Label>
                </td>
            <td>
                <asp:DropDownList ID="ddlLawers" runat="server" 
                    CssClass="userselect" DataTextField="FullName" 
                    DataValueField="LawerId" Width="250px">
                </asp:DropDownList>
                </td>
        ...
        <tr>
            ...
            <td><asp:Label ID="lblDataSources" runat="server" meta:resourcekey="lblDataSources" 
