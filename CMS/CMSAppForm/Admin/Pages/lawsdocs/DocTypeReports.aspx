<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocTypeReports.aspx.cs" Inherits="Admin_Pages_lawsdocs_DocTypeReports" %>
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="DocId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnName" runat="server" Text="Tên văn bản" meta:resourcekey="lblGridColumnName"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                ...
                <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnDesc" runat="server" Text="Ngày ban hành" meta:resourcekey="lblGridColumnDaDuyet"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                ...
                <asp:TemplateField  > 
                    <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnTime" runat="server" Text="Nguồn Luật ViệtNam" meta:resourcekey="lblGridColumnDownload"></asp:Label>
                    </HeaderTemplate>  
                    <ItemTemplate> 
                        <span class="ngaythang">
                            <%# Eval("NguonLVN") %>
                    ...
                    <ItemStyle Width="11%" HorizontalAlign = "center" Wrap="false" />  
                    <HeaderStyle Width="11%" />        
                </asp:TemplateField>  
                <asp:TemplateField  > 
                    <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnTime" runat="server" Text="Nguồn ngoài" meta:resourcekey="lblGridColumnDownload"></asp:Label>
                    </HeaderTemplate>  
                    <ItemTemplate> 
                        <span class="ngaythang">
                            <%# Eval("NguonNgoai") %>
