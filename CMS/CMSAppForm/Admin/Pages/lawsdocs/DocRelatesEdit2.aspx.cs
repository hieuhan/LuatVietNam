...
public partial class Admin_DocRelatesEdit2 : System.Web.UI.Page
{
    ...
    private void BindData(int index)
    {
        try
        {
            ...
            string m_RelateTypeId = RelateTypeId.ToString();
            int m_CrUserId = 0;
            string m_DateFrom="";
            string m_DateTo = "";
    ...
    protected void m_grid_REL_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            short updateId = Int16.Parse(m_grid_REL.DataKeys[id].Value.ToString());
            if (updateId > 0)
            {
                DocRelates m_DocRelates = new DocRelates();
    ...
    protected void lbAddVBCancu_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(5, txtVBCancu.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, RelateTypeId);
            txtVBCancu.Text = "";
        }
        catch (Exception ex)
        {
   ...
   protected void lbAddVBHethieuluc_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(5, txtVBHethieuluc.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, RelateTypeId);
            txtVBHethieuluc.Text = "";           
        }
        catch (Exception ex)
        {
