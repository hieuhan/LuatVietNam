<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocsConsolidationEdit.aspx.cs" Inherits="Admin_DocsEdit" %>
   ...
   <style type="text/css">
    ...
    <table cellpadding="3" cellspacing="0" style="width: 90%; font-weight: lighter">
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:TextBox ID="txtDocName" runat="server" Width="100%"
                    CssClass="tukhoatimekiem" Height="70px" TextMode="MultiLine"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvDocName" Text="Bạn cần nhập Tên văn bản" runat="server" Display="Dynamic"
                    ErrorMessage="Tên văn bản" ValidationGroup="G1" SetFocusOnError="true"
        ...
        <tr>
            ...
            <td style="width: 35%">
                ...
                <br />
                <asp:CompareValidator ID="cvDocTypes" runat="server" ErrorMessage="Loại văn bản"
        ...
        <tr>
            <td style="width: 15%">
                <asp:Label ID="lblIssueDate" runat="server" Text="Ngày ký xác thực:" ></asp:Label>
                <span class="icon-required"></span>
            </td>
            <td style="width: 35%">
                ...
                (dd/MM/yyyy)
                <br />
                <asp:RequiredFieldValidator ID="rfvIssueDate" Text="Bạn cần nhập Ngày ký xác thực" runat="server" Display="Dynamic"
                    ErrorMessage="Ngày ký xác thực" ValidationGroup="G1" SetFocusOnError="true"
        ...
        <tr>
            ...
            <td style="width: 35%">
                <asp:TextBox ID="txtGazetteNumber" runat="server" Width="90%"
        ...
        <tr>
            ...
            <td style="width: 35%">
                <asp:TextBox ID="txtGazetteDate" runat="server" Width="90%"
                    CssClass="tukhoatimekiem"></asp:TextBox>
                <a class="help-lnk" href="javascript:void(0)" title="Chọn hoặc nhập ngày tháng theo định dang dd/MM/yyyy" ><span class="aui-icon aui-icon-small aui-iconfont-help">?</span></a>
                (dd/MM/yyyy)<br />
        ...
        <%--<tr>
            ...
            <td style="width: 15%">Văn bản liên quan</td>
            <td></td>
        </tr>--%>
        <tr>
            <td style="width: 15%">
        ...
        <tr>
            ...
            <td colspan="3">
                <CKEditor:CKEditorControl ID="txtDocContent" runat="server"  PasteFromWordRemoveStyles="false" PasteFromWordPromptCleanup="true" 
                    BasePath="~/Integrated/ckeditor/" Height="270px" Width="100%"></CKEditor:CKEditorControl>
                <%----%>
            </td>
        </tr>
    </table>
    ...
    <input type="button" name="ctl00$m_contentBody$btnSaveAndNewHide" value="Lưu và thêm mới" id="m_contentBody_btnSaveAndNewHide2" title="Lưu và tiếp tục thêm mới văn bản khác" class="luuvathemmoi"/>
        ...
        <asp:LinkButton ID="btnSaveAndNew" runat="server" CssClass="luuvathemmoi hidden-save" ToolTip="Lưu và tiếp tục thêm mới văn bản khác"
    ...
    <script type="text/javascript">
        ...
        function validDocsEditForm() {
            try {
                ...
                var cvDocTypes = $('#<%:cvDocTypes.ClientID%>');
                if (ddlDocTypes.val() == 0) {
                    cvDocTypes.css({ 'display': 'inline' });
                    if (focusInput == null) {
                ...
                if (!isEmpty(txtEffectDate.val()) && !isStrDateddMMyyyy(txtExpireDate.val())) {
