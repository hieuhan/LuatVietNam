<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="FeedBackGroups.aspx.cs" Inherits="Admin_Pages_lawsdocs_FeedBackGroups" %>
        ...
        <ContentTemplate>--%>
            ...
            <div class="khungchucnang">
                ...
                <div class="chucnangright">
                    <a id="popup" href="FeedBackGroupsEdit.aspx" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>"
                        class="themmoi">
                ...
                <div class="contenbangdulieu">
                    <asp:GridView ID="m_grid" DataKeyNames="FeedBackGroupId" runat="server" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>'
                                        ToolTip='<%# Eval("FeedBackGroupId").ToString() %>'> </asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltFeedBackGroupName" runat="server" EnableViewState="false" Text='<%# Eval("FeedBackGroupName") %>'></asp:Literal>
                                    <asp:Label ID="lblFeedBackGroupName" runat="server" Text='<%# Eval("FeedBackGroupName")%>' Visible="false"></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltFeedBackGroupDesc" runat="server" EnableViewState="false" Text='<%# Eval("FeedBackGroupDesc") %>'></asp:Literal>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="25%" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("FeedBackGroupId") %>')" href='FeedBackGroupsEdit.aspx?FeedBackGroupId=<%# Eval("FeedBackGroupId") %>'
                                    ...
                                    <br />
                                    <a class="dropdown-menu-hover-1-<%# Eval("FeedBackGroupId") %>" href="#" data-dropdown="#dropdown-1-<%# Eval("FeedBackGroupId") %>">
                                    </a>
                                </ItemTemplate>
