...
public partial class Admin_CustomersResetPassword : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            m_grid.DataSource = m_Customers.GetPage(ActUserId, m_grid.PageSize, CustomPaging.PageIndex - 1, m_OrderBy, m_CustomerName,m_CustomerFullName, m_CustomerNickName, 
                                                    ...
                                                    m_ApplicationId,m_PlatformId, m_BusinessPartnerId, m_AppPlatformId, m_MapCustomerId, m_CustomerGroupId, m_OccupationId, m_OrganOccupationId,
                                                    m_InfoChannelId, m_RegisterNewsletter, OrganTaxCode, m_DateFrom, m_DateTo, ref RowCount);
            m_grid.DataBind();
