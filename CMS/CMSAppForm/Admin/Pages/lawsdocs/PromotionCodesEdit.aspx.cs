/* ********************************************************************************
'     Document    :  PromotionCodesEdit.aspx.cs
' ********************************************************************************/
using System;
using System.Web.UI;
using System.Text;
...
public partial class admin_pages_PromotionCodesEdit : System.Web.UI.Page
{		
    ...
    private void bindData()
    {
        ...
        else
        {
            ...
            txPromotionCode.Text = m_PromotionCodes.PromotionCode.ToString();
            txUsingCount.Text = m_PromotionCodes.UsingCount.ToString();
