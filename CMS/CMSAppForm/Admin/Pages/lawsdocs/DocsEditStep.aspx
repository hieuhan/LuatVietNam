<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdminEdit.master" AutoEventWireup="true" CodeFile="DocsEditStep.aspx.cs" Inherits="Admin_DocsEditStep" %>
...
function SetValue2(row, index, name, textbox) {
    ...
    input.type = "textare";
    input.name = name;
    input.style = "height:65px;width:100%;";
    input.value = textbox;
    row.cells[index].appendChild(input);
...
<style type="text/css">
        ...
        <tr  runat="server" visible="false">
            ...
            <td valign="top">
                ...
                <tr>
                    ...
                    <tr runat="server" visible="false">
                    <td class="style2"> <asp:Label ID="lblSigners" runat="server" Text="Người ký:"  meta:resourcekey="lblSigners"></asp:Label> </td>
                    <td>                                            
                ...
                <tr runat="server" visible="false">
                    <td class="style2">
                        <asp:Label ID="lblKeywords" runat="server" Text="Từ khóa:"  Visible="false" meta:resourcekey="lblKeywords"></asp:Label>
                    </td>
                    <td>                                            
        ...
        <tr>
            <td colspan="2">
                <div style="padding:5px;">        
                    <a <%if(!isDisableStep) { %> href="javascript:void(0)" onclick="AddRow()" <%} else { %> title="Không thể sửa thủ tục hành chính khi đã duyệt." <%} %>class="luuvathemmoi" >Thêm bước</a>
                </div>
                <div>
                    <asp:GridView ID="gvDocStep" DataKeyNames="DocStepId" runat="server" ShowHeader="True"
                    AutoGenerateColumns="False" CssClass="grid" PageSize="50" Width="100%" 
                    ...
                    <asp:TemplateField HeaderText="Thư tự">
                        <ItemTemplate>                                    
                            <asp:TextBox Width="50px" ID="tbStepOrder" runat="server" Text='<%# Eval("StepOrder") %>'></asp:TextBox>
                        </ItemTemplate>
                        <ItemStyle Width="50px" HorizontalAlign = "Left" VerticalAlign="Middle" Wrap="false" />  
                    ...
                    <asp:TemplateField  > 
                        ...
                        <ItemTemplate> 
                            <asp:TextBox ID="tbStepContent" runat="server" Text='<%# Eval("StepContent") %>' TextMode="MultiLine" Height="65px" Width="100%"></asp:TextBox>
                        </ItemTemplate>
    ...
    <div style="background-color: #FFFFFF; bottom: 0px;  padding: 8px;  position: fixed;   right: 1px;   text-align: right;  width: 100%;">
        ...
        <asp:LinkButton ID="btnSave" runat="server" CssClass="luuvaquaylai" ToolTip="Lưu thông tin"
