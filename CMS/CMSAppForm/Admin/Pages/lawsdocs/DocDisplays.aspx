<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocDisplays.aspx.cs" Inherits="Admin_DocDisplays" %>
...
<script src="../../Js/ajaxTooltip/ajax.js" type="text/javascript"></script>
	...
	<div class="chucnangright">
		<a id="popup" href="DocsSelected.aspx?DocGroupId=<%= DocGroupId %>&DisplayTypeId=<%= ddlDisplayTypes.SelectedValue %>&LanguageId=<%=ddlLanguage.SelectedValue %>&FileTypeId=<%=FileTypeId %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="DocDisplayId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            OnRowDeleting="m_grid_RowDeleting" OnRowDataBound = "m_grid_OnRowDataBound" OnRowCommand="m_grid_OnRowCommand"
            ...
            <Columns>                        
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        ...
                        <asp:LinkButton ID="lbDelete" runat="server" CssClass="iconadmxoa" CommandName="Delete" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" ToolTip="Xóa" meta:resourcekey="lnkGridColumnDel"></asp:LinkButton> 
