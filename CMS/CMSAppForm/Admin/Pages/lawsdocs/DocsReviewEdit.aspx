<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocsReviewEdit.aspx.cs" Inherits="Admin_DocsReviewEdit" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlEffectStatus" runat="server" CssClass="userselect"  
                    ...
                    Width="250px"></asp:DropDownList>
                <asp:Label ID="lblReviewStatus" runat="server" Text="Trạng thái:" meta:resourcekey="lblReviewStatus" Visible="false"></asp:Label>
