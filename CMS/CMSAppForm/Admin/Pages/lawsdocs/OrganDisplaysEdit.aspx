<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdminEdit.master" AutoEventWireup="true" CodeFile="OrganDisplaysEdit.aspx.cs" Inherits="Admin_OrganDisplaysEdit" %>
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    <table cellpadding="3" cellspacing="0" style="width:100%; font-weight:lighter">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlOrgans" runat="server" Enabled="false"
