<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="MessageSends.aspx.cs" Inherits="Admin_MessageSends" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    ...
    <div class="chucnangleft">
        ...
        <%=GetLocalResourceObject("MessageSends").ToString()%>
	</div>
        ...
        <asp:GridView ID="m_grid" DataKeyNames="MessageSendId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                     <a id="popup2"  href='<%# "MessageSendShowContent.aspx?MessageSendId=" + Eval("MessageSendId").ToString()%>'  style="color:Black; font-weight:normal;"  WHeight="500" WWidth="700" title="<%=GetLocalResourceObject("lblGridColumnShowContent.title").ToString() %>"><%# Eval("Title")%></a>
                    </ItemTemplate>
