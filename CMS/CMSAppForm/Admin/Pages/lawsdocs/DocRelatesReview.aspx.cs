...
public partial class Admin_DocRelatesReview : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            byte m_DocGroupId = byte.Parse(ddlDocGroups.SelectedValue);
            string m_OrderBy = "";
            ...
            m_grid.DataSource = m_DocRelates.GetPage(ActUserId, m_grid.PageSize, CustomPaging.PageIndex - 1, m_OrderBy, m_LanguageId,m_DocGroupId, m_Field, m_DocId, m_DocIdentity, m_DocReferenceId, m_RelateTypeId, m_ReviewStatusId, m_CrUserId, m_SearchByDate, m_DateFrom, m_DateTo, ref RowCount);
    ...
    private void Review_Click(byte ReviewStatusId)
    {
        ...
        Message = "Duyệt thành công " + CountSuc.ToString() + " liên kết văn bản. ";
        if (ReviewStatusId != 2)
            Message = "Bỏ duyệt thành công " + CountSuc.ToString() + " liên kết văn bản. ";
        BindData();
    ...
    protected void lbDelete_Click(object sender, EventArgs e)
    {
        ...
        Message = "Xóa thành công " + CountSuc.ToString() + " liên kết văn bản. ";
        if (CountFalseByStatus > 0)
        {
            Message += "Xóa thất bại " + CountFalseByStatus.ToString() + " liên kết văn bản do đang ở trạng thái đã duyệt. ";
        }
