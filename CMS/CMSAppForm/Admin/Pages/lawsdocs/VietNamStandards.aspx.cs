...
public partial class Admin_VietNamStandards : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //selected
            if (Session["VietNamStandards-ddlDocTypes"] != null && Request.UrlReferrer != null && (Request.UrlReferrer.OriginalString.Contains("DocsUpdateContentEdit.aspx") || Request.UrlReferrer.OriginalString.Contains("VietNamStandardsEdit.aspx") || Request.UrlReferrer.OriginalString.Contains("DocsContentRelation.aspx") || Request.UrlReferrer.OriginalString.Contains("DocIndexes.aspx")))
            {
                ddlDocTypes.SelectedValue = Session["VietNamStandards-ddlDocTypes"].ToString();
                ddlCrUserId.SelectedValue = Session["VietNamStandards-ddlCrUserId"].ToString();
                ddlDataSources.SelectedValue = Session["VietNamStandards-ddlDataSources"].ToString();
                ddlDocTypes.SelectedValue = Session["VietNamStandards-ddlDocTypes"].ToString();
                ddlEffectStatus.SelectedValue = Session["VietNamStandards-ddlEffectStatus"].ToString();
                ddlFields.SelectedValue = Session["VietNamStandards-ddlFields"].ToString();
                ddlLanguage.SelectedValue = Session["VietNamStandards-ddlLanguage"].ToString();
                ddlOrderBy.SelectedValue = Session["VietNamStandards-ddlOrderBy"].ToString();
                ddlOrgans.SelectedValue = Session["VietNamStandards-ddlOrgans"].ToString();
                ddlPageSize.SelectedValue = Session["VietNamStandards-ddlPageSize"].ToString();
                ddlProvinces.SelectedValue = Session["VietNamStandards-ddlProvinces"].ToString();
                ddlReviewStatus.SelectedValue = Session["VietNamStandards-ddlReviewStatus"].ToString();
                ddlRevUserId.SelectedValue = Session["VietNamStandards-ddlRevUserId"].ToString();
                ddlSearchByDate.SelectedValue = Session["VietNamStandards-ddlSearchByDate"].ToString();
                ddlUpdUserId.SelectedValue = Session["VietNamStandards-ddlUpdUserId"].ToString();
                ddlUseStatus.SelectedValue = Session["VietNamStandards-ddlUseStatus"].ToString();
                txtDateFrom.Text = Session["VietNamStandards-txtDateFrom"].ToString();
                txtDateTo.Text = Session["VietNamStandards-txtDateTo"].ToString();
                txtSearch.Text = Session["VietNamStandards-txtSearch"].ToString();
                rblFindTypes.SelectedValue = Session["VietNamStandards-rblFindTypes"].ToString();
                ckbIsSearchExact.Checked = bool.Parse(Session["VietNamStandards-ckbIsSearchExact"].ToString());
            }
            BindData();
        }
    ...
    private void BindData()
    {
        try
        {
            ...
            m_Docs.DocGroupId = DocGroups.TCVN;//Tiêu chuẩn Việt Nam
            int IssueYear = 0;
            ...
            //rptStatusCount.DataSource = m_Docs.StatisticByReviewStatus(ref RowCount, DocGroups.TCVN, 1, 0, "", 0, "", "", byte.Parse(ddlDocTypes.SelectedValue));
            rptStatusCount.DataSource = m_Docs.StatisticByReviewStatusV2(ref RowCount, DocGroups.TCVN, 1, byte.Parse(ddlLanguage.SelectedValue), m_SearchKeyword,
    ...
    {
        Session["VietNamStandards-ddlDocTypes"] = ddlDocTypes.SelectedValue;
        Session["VietNamStandards-ddlCrUserId"] = ddlCrUserId.SelectedValue;
        Session["VietNamStandards-ddlDataSources"] = ddlDataSources.SelectedValue;
        Session["VietNamStandards-ddlDocTypes"] = ddlDocTypes.SelectedValue;
        Session["VietNamStandards-ddlEffectStatus"] = ddlEffectStatus.SelectedValue;
        Session["VietNamStandards-ddlFields"] = ddlFields.SelectedValue;
        Session["VietNamStandards-ddlLanguage"] = ddlLanguage.SelectedValue;
        Session["VietNamStandards-ddlOrderBy"] = ddlOrderBy.SelectedValue;
        Session["VietNamStandards-ddlOrgans"] = ddlOrgans.SelectedValue;
        Session["VietNamStandards-ddlPageSize"] = ddlPageSize.SelectedValue;
        Session["VietNamStandards-ddlProvinces"] = ddlProvinces.SelectedValue;
        Session["VietNamStandards-ddlReviewStatus"] = ddlReviewStatus.SelectedValue;
        Session["VietNamStandards-ddlRevUserId"] = ddlRevUserId.SelectedValue;
        Session["VietNamStandards-ddlSearchByDate"] = ddlSearchByDate.SelectedValue;
        Session["VietNamStandards-ddlUpdUserId"] = ddlUpdUserId.SelectedValue;
        Session["VietNamStandards-ddlUseStatus"] = ddlUseStatus.SelectedValue;
        Session["VietNamStandards-txtDateFrom"] = txtDateFrom.Text;
        Session["VietNamStandards-txtDateTo"] = txtDateTo.Text;
        Session["VietNamStandards-txtSearch"] = txtSearch.Text;
        Session["VietNamStandards-rblFindTypes"] = rblFindTypes.SelectedValue;
        Session["VietNamStandards-ckbIsSearchExact"] = ckbIsSearchExact.Checked;
