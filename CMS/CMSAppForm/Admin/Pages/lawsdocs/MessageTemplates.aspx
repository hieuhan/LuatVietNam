<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="MessageTemplates.aspx.cs" Inherits="Admin_MessageTemplates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    ...
    <table cellpadding="2" cellspacing="0" style="width:100%">
        <tr>
            ...
            <td style="width:70px; white-space:nowrap;"></td>
            <td></td>
        </tr>
        <tr>
            ...
            <td style="width:90px; white-space:nowrap;">
                <asp:Label ID="lblMessageName" runat="server" 
                    meta:resourcekey="lblMessageName" Text="Tên tin nhắn:"></asp:Label>
                </td>
            <td>
    ...
    <div class="chucnangleft">
        ...
        <%=GetLocalResourceObject("MessageTemplates").ToString()%>
	</div>
	<div class="chucnangright">
		<a id="popup" href="MessageTemplatesEdit.aspx" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
...
<%--    <div style="text-align:left; width:30%; float:right"><asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="upn_Grid" runat="server">
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="MessageTemplateId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                <asp:TemplateField >
                 ...
                 <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnMessageName" runat="server" Text="Tên tin nhắn" meta:resourcekey="lblGridColumnMessageName"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                        <%# Eval("MessageName")%> 
                    </ItemTemplate>
               ...
               <asp:TemplateField  > 
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("MessageTemplateId") %>')" href='MessageTemplatesEdit.aspx?MessageTemplateId=<%# Eval("MessageTemplateId") %>' class="iconadmsua"
