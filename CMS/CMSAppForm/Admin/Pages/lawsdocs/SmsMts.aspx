<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="SmsMts.aspx.cs" Inherits="Admin_SmsMts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    ...
    <table cellpadding="4" cellspacing="0" style="width:100%">
        <tr>
            ...
            <td style="width:100px; white-space:nowrap;">
                <asp:Label ID="lblMessageOut" runat="server" meta:resourcekey="lblMessageOut" 
                    Text="Nội dung tin nhắn:"></asp:Label>
                </td>
            <td>
                <asp:TextBox ID="txtMessageOut" runat="server" CssClass="tukhoatimekiem" 
                    Width="240px"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblSmsMtstatus" runat="server" meta:resourcekey="lblSmsMtstatus" 
    ...
    <div class="chucnangleft">
        ...
        <%=GetLocalResourceObject("SmsMts").ToString()%>
	</div>
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="MtId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                <asp:TemplateField >
                    ...
                    <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>' 
                                     ToolTip ='<%# Eval("MtId").ToString() %>'> </asp:Label>
                    </ItemTemplate>      
                ...
                <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnMessageIn" runat="server" Text="MO" meta:resourcekey="lblGridColumnMessageIn"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                        <%# Eval("MessageIn")%> 
                    </ItemTemplate>
                 ...
                 <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnMessageOut" runat="server" Text="Tin nhắn" meta:resourcekey="lblGridColumnMessageOut"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                        <%# Eval("MessageOut")%> 
                    </ItemTemplate>
               ...
               <asp:TemplateField  > 
                ...
                <asp:TemplateField Visible="false">
                    ...
                    <ItemTemplate> 
                        <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("MtId") %>')" href='SmsMtsEdit.aspx?MtId=<%# Eval("MtId") %>' class="iconadmsua"
