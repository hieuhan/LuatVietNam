...
public partial class Admin_DocRelatesVietNamStandard : System.Web.UI.Page
{
    ...
    protected void lbAddVBCancu_Click(object sender, EventArgs e)//TC bi sua doi bo xung
    {
        try
        {
            AddDatasetTemp(3,int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBCancu.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 24);
            txtVBCancu.Text = "";
        }
        catch (Exception ex)
        {
    ...
    public void AddDatasetTemp(int RowAmount, string DocIdentity, byte ReviewStatusId, byte LanguageId, byte RelateTypeId)
    {
        ...
        Docs m_Docs = new Docs();
        DataSet ds;
        ds = m_Docs.Docs_GetTopByDocIdentity(ActUserId, RowAmount, "", LanguageId, DocIdentity.Replace(",", ";"), 0);
    ...
    protected void lbAddVBHethieuluc_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(3,int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBHethieuluc.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 30);
            txtVBHethieuluc.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbAddVBBisuadoi_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(3, int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBBisuadoi.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 31);
            txtVBBisuadoi.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbAddVBDuocdinhchinh_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(3, int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBDuocdinhchinh.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 32);
    ...
    protected void lbtCongBo_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBCongBo.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 23);
            txtVBBisuadoi.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbtHuyBo_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBHuyBo.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 21);
            txtVBBisuadoi.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbtVBDuocDanChieu_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBDuocDanChieu.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 34);
            txtVBBisuadoi.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbtVBDuocCanCu_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtVBDuocCanCu.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 35);
            txtVBBisuadoi.Text = "";
        }
        catch (Exception ex)
        {
    ...
    protected void lbtTCDuocCanCu_Click(object sender, EventArgs e)
    {
        try
        {
            AddDatasetTemp(3,int.Parse(ConfigurationManager.AppSettings["PAGESIZE_GET_TOP_BY_IDENTITY"]), txtTCDuocCanCu.Text, ConstantHelpers.REVIEW_STATUS_REVIEW, LanguageId, 33);
            txtVBBisuadoi.Text = "";
        }
        catch (Exception ex)
        {
