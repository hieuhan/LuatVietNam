...
public partial class Admin_SmsMts : System.Web.UI.Page
{
    protected int ActUserId = 0;
    protected int MtId = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DropDownListHelpers.DDLOrderBy_BindByCulture(ddlOrderBy, OrderByClauses.Static_GetList("SmsMts"), "");
            BindData();
        }
    ...
    private void BindData()
    {
        try
        {
            ...
            string m_MessageOut = txtMessageOut.Text;
            byte m_MsgTypeId = 0;
            byte m_FeeTypeId = 0;
            int m_MoId = 0;
            ...
            m_grid.DataSource = m_SmsMts.GetPage(ActUserId, m_grid.PageSize, CustomPaging.PageIndex - 1, m_OrderBy,m_MoId, m_UserId, m_PrefixId, m_TelcoId, m_RequestId, m_SmsServiceId, m_MessageOut, m_MsgTypeId, m_FeeTypeId, m_SmsProcessStatusId,m_DateFrom, m_DateTo, ref RowCount);
            m_grid.DataBind();
    ...
    protected void m_grid_OnRowDataBound(Object sender, GridViewRowEventArgs e)
    {
        ...
        {
            MtId = int.Parse(m_grid.DataKeys[e.Row.RowIndex].Value.ToString());            
        }
    }
