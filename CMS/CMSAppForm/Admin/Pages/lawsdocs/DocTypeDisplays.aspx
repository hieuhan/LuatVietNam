<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="DocTypeDisplays.aspx.cs" Inherits="Admin_DocTypeDisplays" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
	...
	<div class="chucnangright">
		<a id="popup" href="DocTypeDisplaysSelected.aspx?DisplayTypeId=<%= ddlDisplayTypes.SelectedValue %>&LanguageId=<%=ddlLanguage.SelectedValue %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
            <asp:Label ID="lblAddNew" runat="server" Text="Chọn loại VB" meta:resourcekey="lblAddNew"></asp:Label>
        </a>
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="DocTypeDisplayId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup1" onmouseover="ShowMenu('-1-<%# Eval("DocTypeDisplayId") %>')" href='DocTypeDisplaysEdit.aspx?DocTypeDisplayId=<%# Eval("DocTypeDisplayId") %>&DocTypeId=<%# Eval("DocTypeId") %>&LanguageId=<%=ddlLanguage.SelectedValue %>' class="iconadmsua"
