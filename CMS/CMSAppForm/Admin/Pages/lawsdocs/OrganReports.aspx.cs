...
public partial class Admin_Pages_lawsdocs_OrganReports : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            OrganReports m_OrganReports = new OrganReports();
            int RowCount = 0;
            short Week = 0;
            byte Month = 0;
            int Year = 0;
            ...
            m_grid.DataSource = m_OrganReports.GetList(0, Week, Month, Year, m_DateFrom, m_DateTo, "", CustomPaging.PageIndex - 1, m_grid.PageSize, ref RowCount);
            m_grid.DataBind();
