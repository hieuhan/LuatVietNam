...
public partial class Admin_DocsEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            DropDownListHelpers.DDLDocTypeDisplays_BindByCulture(ddlDocTypes, DocTypeDisplays.Static_GetList_ByDisplayTypeId((short)54), "");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        //{
            ...
            if (Request.Params["DocId"] == null || Request.Params["DocId"].ToString() == "")
            {
                ...
                Response.Redirect("DocsConsolidationEdit.aspx?DocId=" + DocId.ToString() + "&LanguageId=" + LanguageId.ToString());
            }
            else
            {
                BindData();
        ...
        try
        {
            ...
            if (DocId == 0)
            {
                ...
                else
                {
                    ...
                    {
                        JSAlertHelpers.Alert("Bạn phải chọn văn bản tiếng việt trước khi thêm mới.", this);
