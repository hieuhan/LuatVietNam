<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="CustomersShare.aspx.cs" Inherits="Admin_CustomersShare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
	...
	<div class="chucnangright">
        <a id="popup" href="CustomersShareEdit.aspx?SiteId=<%=SiteId %>&DataTypeId=<%=DataTypeId %>&EnableDataType=<%=EnableDataType %>&ActionId=<%=ActionId %>&LanguageId=<%=LanguageId %>&AppTypeId=<%=AppTypeId %>&CategoryId=<%=CategoryId %>" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                        ...
                        <a id="popup" onmouseover="ShowMenu('-2-<%# Eval("ArticleId") %>')" href='CustomersShareEdit.aspx?ArticleId=<%# Eval("ArticleId") %>&SiteId=<%=SiteId %>&DataTypeId=<%=DataTypeId %>&EnableDataType=<%=EnableDataType %>&ActionId=<%=ActionId %>&LanguageId=<%# Eval("LanguageId") %>&AppTypeId=<%# Eval("ApplicationTypeId").ToString() %>' class="iconadmsua"
                        title="Thêm/sửa chia sẻ"></a>  
                        </div>
                ...
                <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnSummary" runat="server" Text="Mô tả" meta:resourcekey="lblGridColumnSummary"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                        <%# Eval("Summary") %>
                    </ItemTemplate>
                ...
                <asp:TemplateField Visible="false">
                    ...
                    <ItemTemplate> 
                        <a onmouseover="ShowMenu('-1-<%# Eval("ArticleId") %>')" href='CustomersShareEdit.aspx?ArticleId=<%# Eval("ArticleId") %>&SiteId=<%=SiteId %>&DataTypeId=<%=DataTypeId %>&EnableDataType=<%=EnableDataType %>&ActionId=<%=ActionId %>&LanguageId=<%# Eval("LanguageId") %>&AppTypeId=<%# Eval("ApplicationTypeId").ToString() %>' class="iconadmsua"
                        ...
                        <asp:Repeater ID="rptLanguage" runat="server">
                            ...
                            <ItemTemplate>
                                <li>
                                    <a id="popup" href="CustomersShareEdit.aspx?ArticleId=<%# ArticleId %>&SiteId=<%=SiteId %>&DataTypeId=<%=DataTypeId %>&EnableDataType=<%=EnableDataType %>&ActionId=<%=ActionId %>&LanguageId=<%# Eval("LanguageId") %>&AppTypeId=<%# AppTypeId %>" 
