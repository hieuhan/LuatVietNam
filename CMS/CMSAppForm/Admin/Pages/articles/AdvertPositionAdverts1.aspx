<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdminEdit.master" AutoEventWireup="true" CodeFile="AdvertPositionAdverts1.aspx.cs" Inherits="Admin_AdvertPositionAdverts1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    ...
    <table cellpadding="2" cellspacing="0" style="width:100%">
        <tr>
            <td style="width:80px"><asp:Label ID="lblPosition" runat="server" Text="QC: " meta:resourcekey="lblPosition"></asp:Label>
                </td>
            <td>
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="AdvertPositionAdvertId" runat="server" ShowHeaderWhenEmpty="True"
