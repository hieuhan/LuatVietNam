<%@ Page Language="C#" MasterPageFile="~/admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="DataDictionaryTypes.aspx.cs" Inherits="admin_pages_DataDictionaryTypes"
    Title="" %>
        ...
        <ContentTemplate>
            ...
            <table cellpadding="2" cellspacing="0" style="width: 100%">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtContentSearch" runat="server" CssClass="tukhoatimekiem" Width="240px"></asp:TextBox>&nbsp;<asp:LinkButton ID="btnSearch" runat="server" CssClass="timkiembutom" meta:resourcekey="btnSearch"
            ...
            <div class="khungchucnang">
                ...
                <div class="chucnangright">
                    <a id="popup" href="DataDictionaryTypesEdit.aspx"
                ...
                <div class="contenbangdulieu">
                    <asp:GridView ID="m_grid" DataKeyNames="DataDictionaryTypeId" runat="server" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>'
                                        ToolTip='<%# Eval("DataDictionaryTypeId").ToString() %>'> </asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltDataDictionaryTypeName" runat="server" EnableViewState="false"
                                        Text='<%# Eval("DataDictionaryTypeName") %>'></asp:Literal>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltDataDictionaryTypeDesc" runat="server" EnableViewState="false"
                                        Text='<%# Eval("DataDictionaryTypeDesc") %>'></asp:Literal>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <a id="popup" href='DataDictionaryTypesEdit.aspx?DataDictionaryTypeId=<%# Eval("DataDictionaryTypeId") %>'
