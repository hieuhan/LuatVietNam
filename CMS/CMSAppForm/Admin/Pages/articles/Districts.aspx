<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Districts.aspx.cs" Inherits="Admin_Pages_articles_Districts" %>
        ...
        <ContentTemplate>
            ...
            <div class="khungchucnang">
                ...
                <div class="chucnangright">
                    <a id="popup" href="DistrictsEdit.aspx?CountryId=<%=CountryId %>&ProvinceId=<%=ProvinceId %>&LanguageId=<%=LanguageId %>&AppTypeId=<%=AppTypeId %>"
                ...
                <div class="contenbangdulieu">
                    <asp:GridView ID="m_grid" DataKeyNames="DistrictId" runat="server" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>'
                                        ToolTip='<%# Eval("DistrictId").ToString() %>'> </asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltDistrictName" runat="server" EnableViewState="false" Text='<%# Eval("DistrictName") %>'></asp:Literal>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltDistrictDesc" runat="server" EnableViewState="false" Text='<%# Eval("DistrictDesc") %>'></asp:Literal>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <a id="popup" href='DistrictsEdit.aspx?DistrictId=<%# Eval("DistrictId") %>'
