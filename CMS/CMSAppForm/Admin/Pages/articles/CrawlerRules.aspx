<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="CrawlerRules.aspx.cs" Inherits="Admin_CrawlerRules" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
	...
	<div class="chucnangright">
        <a id="popup" href="CrawlerRulesEdit.aspx?SiteId=<%=SiteId %>" title="Thêm mới" class="themmoi" > 
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="CrawlerRuleId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField>  
                  ...
                  <ItemTemplate>
                    <%# CrawlerContentTypes.Static_Get(byte.Parse(Eval("CrawlerContentTypeId").ToString()), l_CrawlerContentTypes).CrawlerContentTypeDesc %>
                  </ItemTemplate>
                </asp:TemplateField> 
                <asp:TemplateField> 
                    <HeaderTemplate>                                
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup" href='CrawlerRulesEdit.aspx?CrawlerRuleId=<%# Eval("CrawlerRuleId") %>' class="iconadmsua"
