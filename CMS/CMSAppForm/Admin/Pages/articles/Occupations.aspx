<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true"
    CodeFile="Occupations.aspx.cs" Inherits="Admin_Pages_articles_Occupations" %>
        ...
        <ContentTemplate>
            ...
            <div class="khungchucnang">
                ...
                <div class="chucnangright">
                    <a id="popup" href="OccupationsEdit.aspx" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>"
                        class="themmoi">
                ...
                <div class="contenbangdulieu">
                    <asp:GridView ID="m_grid" DataKeyNames="OccupationId" runat="server" ShowHeaderWhenEmpty="True"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lbNo" runat="server" Text='<%# Container.DataItemIndex + (CustomPaging.PageIndex - 1) * m_grid.PageSize + 1%>'
                                        ToolTip='<%# Eval("OccupationId").ToString() %>'> </asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltOccupationName" runat="server" EnableViewState="false" Text='<%# Eval("OccupationName") %>'></asp:Literal>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Literal ID="ltOccupationDesc" runat="server" EnableViewState="false" Text='<%# Eval("OccupationDesc") %>'></asp:Literal>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="25%" />
                            </asp:TemplateField>
                            <asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <span class="ngaythang">
                                         <%# UserHelpers.Static_Get(Convert.ToInt32(Eval("CrUserId").ToString() == "" ? "0" : Eval("CrUserId").ToString()), l_Users, "").Username%>
                                    </span>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <a id="popup" onmouseover="ShowMenu('-1-<%# Eval("OccupationId") %>')" href='OccupationsEdit.aspx?OccupationId=<%# Eval("OccupationId") %>'
                                    ...
                                    <br />
                                    <a class="dropdown-menu-hover-1-<%# Eval("OccupationId") %>" href="#" data-dropdown="#dropdown-1-<%# Eval("OccupationId") %>">
                                    </a>
                                </ItemTemplate>
