<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Roles.aspx.cs" Inherits="Admin_Roles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="m_contentBody" Runat="Server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('a#popupAction').live('click', function (e) {
                var page = $(this).attr("href")
                var cdialog = $('<div id="divEdit"></div>')
                .html('<iframe id="ifEdit" style="border: 0px; " src="' + page + '" width="98%" height="98%"></iframe>')
                .dialog({
    ...
    <div class="chucnangleft">
        ...
        <%=GetLocalResourceObject("Role").ToString() %>
	</div>
	<div class="chucnangright">
		<a id="popup" href="RolesEdit.aspx?" title="<%=GetLocalResourceObject("lnkAddNew.title").ToString() %>" class="themmoi" > 
    ...
    <div class="contenbangdulieu">
        ...
        <asp:GridView ID="m_grid" DataKeyNames="RoleId" runat="server" ShowHeaderWhenEmpty="True"
            ...
            <Columns>                        
                ...
                <asp:TemplateField > 
                        <HeaderTemplate>                                
                        <asp:Label ID="lblGridColumnName" runat="server" Text="Tên nhóm chức năng" meta:resourcekey="lblGridColumnName"></asp:Label>
                    </HeaderTemplate> 
                    <ItemTemplate> 
                        <%# Eval("RoleName") %> 
                    </ItemTemplate>
                ...
                <asp:TemplateField > 
                    ...
                    <ItemTemplate> 
                         <a id="popupAction" href='RoleAction.aspx?RoleId=<%# Eval("RoleId") %>' class="dieuhuong123"
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate> 
                        <a id="popup" href='RolesEdit.aspx?RoleId=<%# Eval("RoleId") %>' class="iconadmsua"
