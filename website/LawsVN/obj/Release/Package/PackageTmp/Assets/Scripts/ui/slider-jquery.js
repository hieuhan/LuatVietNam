/*Bengin custom*/
if ($("#slider1_container").length > 0 || $("#slider1_container_2").length > 0) {
    jQuery(document).ready(function ($) {
        ...
        if ($("#slider1_container_2").length > 0) {
            $("#slider1_container_2").css("display", "block");
            var jssor_slider2 = new $JssorSlider$("slider1_container_2", options);
        }
        ...
        function ScaleSlider(slider) {
            ...
            if ($("#slider1_container_2").length > 0) {
                ...
                if (parentWidth2) {
                    jssor_slider2.$ScaleWidth(parentWidth2 - 0);
                } else
                    window.setTimeout(ScaleSlider, 30);
            }
        }
...
(function (h, e, b, i, c, g, j) { /*! Jssor */
    ...
    var a = new function () {
        ...
        function Eb() {
            if (!L) {
                ...
                var a;
                if (B.pointerEnabled || (a = B.msPointerEnabled)) L.od = a ? "msTouchAction" : "touchAction"
            }
            return L
        }
        ...
        f.ad = W;
        f.Z = function (a) {
            if (f.fd(a)) a = e.getElementById(a);
            return a
        };
            ...
            e.yd = function (b, a) {
                ...
                if (!e.Rb[f]) {
                    ...
                    for (var c = 0; c < e.$Cols; c++)
                        for (var d = 0; d < e.$Rows; d++) e.Rb[f][d + "," + c] = {
                            $Top: d * a,
                            $Right: c * b + b,
                            $Bottom: d * a + a,
                            $Left: c * b
                ...
                a.e(i, function (G) {
                    ...
                    if (d.$Zoom || d.$Rotate) {
                        ...
                        if (H) {
                            ...
                            f.$Zoom = 1;
                            if (a.T() || a.vc()) e.$Zoom = b.min(e.$Zoom, 2);
                            var N = d.$Rotate;
                    ...
                    if (I) {
                        if (d.$Clip) {
                            ...
                            if (C && z) {
                                i.$Top = h.gb / 2 * w;
                                i.$Bottom = -i.$Top
                            } else if (C) i.$Bottom = -h.gb * w;
                            else if (z) i.$Top = h.gb * w;
                            if (B && A) {
                                i.$Left = h.hb / 2 * w;
                                i.$Right = -i.$Left
                            } else if (B) i.$Right = -h.hb * w;
                            else if (A) i.$Left = h.hb * w
                        }
                        r.$Clip = t;
                        f.$Clip = h[v]
                    }
    ...
    var f = h.$JssorSlider$ = function (q, fc) {
        ...
        function Ac(o, h) {
            ...
            function U(b, e, d) {
                ...
                if (!F) {
                    ...
                    a.T() && a.G(b, (a.G(b) || 0) + 1);
                    if (p.$HWA && a.uc()) (a.uc() < 534 || !eb && !a.de()) && a.oe(b)
                }
                var f = a.P(b);
                a.e(f, function (f) {
                    var i = f.tagName,
                    ...
                    if (k == "caption") {
                        ...
                        if (i == "A") {
                            if (a.u(f, "u") == "image") j = a.of(f, "IMG");
                            else j = a.A(f, "image", c);
                            if (j) {
                                G = f;
                                a.H(G, R);
                                u = a.U(G, c);
                        ...
                        } else if (i == "IMG" && a.u(f, "u") == "image") j = f;
                        if (j) {
                            j.border = 0;
                            a.H(j, R)
                        }
        ...
        var ib = p.$PlayOrientation & 3,
            ...
            wc = a.P(u);
        a.e(wc, function (b) {
            if (b.tagName == "DIV" && !a.u(b, "u")) U.push(b);
            else a.T() && a.G(b, (a.G(b) || 0) + 1)
        });
        var r = -1,
            yb, ub, s = U.length,
            J = p.$SlideWidth || nc,
            ...
            jb, w, K, Ab, O = [],
            Pb, Rb, Nb, dc, Ec, Q, G = p.$PauseOnHover,
    ...
    h.$JssorCaptionSlider$ = function (p, h, f) {
            ...
            function h(c, d) {
                ...
                a.e(o, function (g, h) {
                    ...
                    if (e) {
                        var f = {};
                        if (g == "t") f.ob = e;
                        else if (e.indexOf("%") + 1) f.ye = a.tc(e) / 100;
                        else f.ob = a.tc(e);
                        b[h] = f
                    }
                });
        ...
        function m(w, c, z) {
            ...
            if (c.$Zoom || c.$Rotate) {
                e.$Zoom = (c.$Zoom || 2) - 2;
                if (a.T() || a.vc()) e.$Zoom = b.min(e.$Zoom, 1);
                h.$Zoom = 1;
                var B = c.$Rotate || 0;
                e.$Rotate = B * 360;
                h.$Rotate = 0
